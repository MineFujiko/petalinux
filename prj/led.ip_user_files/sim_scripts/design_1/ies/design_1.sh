...
execute()
{
  irun $irun_opts \
       ...
       -top glbl \
       glbl.v \
       +incdir+"$ref_dir/../../../../led.srcs/sources_1/bd/design_1/ipshared/ec67/hdl" \
       +incdir+"$ref_dir/../../../../led.srcs/sources_1/bd/design_1/ipshared/6b56/hdl" \
       +incdir+"../../../../led.srcs/sources_1/bd/design_1/ipshared/ec67/hdl" \
       +incdir+"../../../../led.srcs/sources_1/bd/design_1/ipshared/6b56/hdl" \
       +incdir+"D:/Xilinx/Vivado/2020.1/data/xilinx_vip/include"
}
